...
dashboardApp.config(['$routeProvider',
    function($routeProvider) {
        $routeProvider.
            ...
            //============ JOBSHEET ============//
            when('/jobSheet', {
                templateUrl: 'partials/jobSheet/list.html'
                ,controller: 'JobSheetController'
            }).
            when('/jobSheetNew', {
                templateUrl: 'partials/jobSheet/form.html'
                ,controller: 'JobSheetNewController'
            }).
            when('/jobSheetDetail/:_id', {
                templateUrl: 'partials/jobSheet/detail.html'
                ,controller: 'JobSheetDetailController'
            }).
            when('/jobSheetEdit/:_id', {
                templateUrl: 'partials/jobSheet/form.html'
...
dashboardApp.filter('slice', function() {
