    ...
    $scope.getTableParam = function(data) {
    	return new ngTableParams({
    	    ...
    	    getData: function($defer, params) {
    	    	...
    	    	// change using modified filter to filter nested json data
    	    	var filteredData = params.filter() ?
    	    		$filter('filter')(data, formatNestedFilters(params.filter()), compareForNestedFiltering ):
    	    		data;
...
//    	            data;
    	        ...
    	        var orderedData = params.sorting() && !$.isEmptyObject(params.sorting()) ?
